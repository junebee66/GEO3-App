...
final class PhotosModel: ObservableObject {
    ...
    let photoCollection = PhotoCollection(albumNamed: "MoLab", createIfNotFound: true)
    ...
    private func unpackPhoto(_ photo: AVCapturePhoto) -> PhotoData? {
        ...
        // get the orientation and apply to uiImage
    ...
    func savePhoto(imageData: Data) {
        ...
        lobbyModel.uploadFromData(imageData)
    }
...
fileprivate let logger = Logger(subsystem: "com.jht1900.CaptureCameraStorage", category: "DataModel")
